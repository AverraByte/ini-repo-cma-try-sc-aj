...
export const metadata: Metadata = {
  title: "About AverraByte",
  description: "Learn more about AverraByte, a leading infrastructure hosting provider.",
}
...
export default function AboutPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div>
        <p>
          AverraByte is a leading infrastructure hosting provider dedicated to providing high-quality, reliable, and
